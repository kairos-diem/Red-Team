...
5. Run a nmap and nikto scan against the machine. <br/> <img src="nmap.png?raw=true" width="800" height="500" /> <br/> <img src="nikto.png?raw=true" width="800" height="800" />
...
7. Metasploit exploitation: Search for trans2open, set rhosts, set payload and run the exploit to get the root.<br/> <img src="metasploit_1.png?raw=true" width="800" height="500" /> <br/> <img src="metasploit_2.png?raw=true" width="800" height="500" /> <br/> <img src="metasploit_3.png?raw=true" width="800" height="500" /> <br/>
8. Manual Exploitation: Download  the github code for it and follow the instructions in the code and run it to get root. <br/> <img src="manual.png?raw=true" width="800" height="500" /> <br/>
  


<h2> Credits </h2>
To all the tools and environment creators and also TCM Security for the Practical Ethical Hacking Course .
